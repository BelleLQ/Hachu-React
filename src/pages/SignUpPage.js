            ...
            <main>
                <div className="container-fluid text-center">
                    <div className="container login-title">
                        <Link to="/login"  className="login-title-grey">Login </Link>
                        <p className="d-inline-block title-or">or</p>
                        <Link to="/signup" className="login-title-black"> Register</Link>
                    </div>
                    <div className="login-form mx-auto my-4">
                        <form>
                            ...
                            <div className="mb-3">
                                <button type="submit" className="btn btn-primary btn-green">Sign Up</button>
                            </div>
                        </form>
                    </div>
                </div>
